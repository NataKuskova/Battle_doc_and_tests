from app import Army


class BattleField:
    """Armies are created and fight here. And the winner is determined.
    ...
    def __init__(self, **kwargs):
        """Initialization armies number, strategy, squads number,
        soldiers number and vehicles number."""
    ...
    def start(self):
        """Armies are created and a battle takes place.
        And the winner is determined.

        Returns:
            The name of the victorious army.
        """
        win = None
